    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "DegreeIntelligence is open source. The homepage says so, and there is a View source code button that takes you straight to the repository.",
