    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "A large under-the-hood cleanup: the biggest screens (and the main dashboard shell) are split into smaller modules so we can ship fixes faster without breaking things.",
        ],
      },
    ],
  },
