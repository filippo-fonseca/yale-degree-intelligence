        ...
        {cells.map((s) => {
          ...
          return (
            <div key={key} className="relative group">
              <button
                type="button"
                data-tour="certificate-heatmap-cell"
                onClick={() =>
                  onOpenRequirement({
                    id: s.req.id,
                    name: s.req.name,
                ...
                className={`flex flex-col justify-between w-full aspect-square rounded-lg border p-1.5 text-left hover:scale-[1.05] transition-transform focus:outline-none focus:ring-2 focus:ring-teal-400/50 ${cellClasses}`}
              >
