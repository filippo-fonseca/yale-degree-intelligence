            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {requirement.options.map((opt) => {
                  ...
                  const style = opt.manual
                    ? "bg-teal-100 dark:bg-teal-900/20 text-teal-700 dark:text-teal-300 border-teal-300 dark:border-teal-700"
                    : opt.completed
              ...
              <div className="space-y-2 border-t border-gray-200 dark:border-gray-800 pt-4">
                ...
                <button
                  ...
                  className="text-sm rounded-full bg-teal-100 dark:bg-teal-900/20 border border-teal-300 text-teal-600 dark:text-teal-300 hover:bg-teal-200 dark:hover:bg-teal-800/30 px-3 py-1.5 flex items-center gap-1"
                >
                  <FiPlus size={12} />
                  Fulfill manually
                </button>
