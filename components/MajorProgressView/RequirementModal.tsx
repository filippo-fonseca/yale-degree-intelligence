      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            role="dialog"
            aria-modal="true"
            className="relative z-[201] overflow-x-hidden w-[min(1000px,92vw)] max-h-[85vh] overflow-y-auto rounded-2xl border border-gray-800 bg-gray-900/95 backdrop-blur-md p-6"
            ...
            <div className="mt-4 space-y-4">
                        ...
                        !opt.skipped && (
                          <div className="flex items-center pl-2 ml-1 border-l border-gray-700">
                            ...
                            <div className="relative group/skip">
                              <button
                                className="flex items-center gap-1 text-[0.7rem] px-2 py-0.5 rounded-full bg-pink-900/20 border border-pink-300 text-pink-300 hover:bg-pink-900 transition-all"
                                onClick={handleSkip}
                              ...
                              <div className="absolute z-50 top-full mt-2 left-1/2 -translate-x-1/2 bg-gray-800 border border-pink-500 text-gray-300 text-xs p-2 rounded-md opacity-0 group-hover/skip:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none">
                                {skipTooltip}
                              </div>
                            </div>
                          </div>
              ...
              <div className="space-y-2 border-t border-gray-800 pt-4">
                ...
                <button
                  ...
                  className="text-sm rounded-full bg-pink-900/20 border border-pink-300 text-pink-300 hover:bg-pink-800/30 px-3 py-1.5 flex items-center gap-1"
                >
                  <FiPlus size={12} />
                  Fulfill manually
                </button>
